variable "k8s_namespace" {
  type        = string
  description = "Name of the Kubernetes namespace where resources will be deployed"
  default     = "px-backup"
}

variable "storage_class_name" {
  type        = string
  description = "Name of the Kubernetes StorageClass to use for backups"
  default     = "px"
}

variable "chart_version_px_backup" {
  type        = string
